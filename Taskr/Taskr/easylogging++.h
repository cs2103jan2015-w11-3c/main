...
public:
    ...
    void setToDefault(void) {
        ...
        setGlobally(ConfigurationType::ToStandardOutput, std::string("false"), false);
    ...
    void setRemainingToDefault(void) {
        ...
        unsafeSetIfNotExist(Level::Global, ConfigurationType::ToStandardOutput, std::string("false"));
